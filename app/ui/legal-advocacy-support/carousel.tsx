...
const carouselItems = [
  {
    image: "/legal-advocacy-support/las.png",
    text: "Legal Advocacy & Support",
  },
  {
    image: "/legal-advocacy-support/1.jpg",
    text: "Ensure Access to Legal Resources.",
  },
  {
    image: "/legal-advocacy-support/2.jpg",
    text: "Promote Legal Rights Awareness",
  },
  {
    image: "/legal-advocacy-support/3.jpg",
    text: "Offer Advocacy and Representation",
  },
  {
    image: "/legal-advocacy-support/4.jpg",
    text: "Foster Inclusive Legal Support",
  },
  {
    image: "/legal-advocacy-support/5.jpg",
    text: "Strengthen Community Connections",
  },
];
    ...
    <section className="mx-auto container max-w-5xl px-8 py-10">
      <div className="text-center my-5 sm:my-30">
        ...
        <h3 className="text-4xl">
          Legal Assistance and Comprehensive Advocacy Services
        </h3>
        ...
        <h4>
          The Legal Advocacy and Support Initiative is designed to provide
          comprehensive legal assistance and advocacy services to Canadian
          communities. This initiative aims to support individuals and groups in
          navigating legal challenges, providing access to justice, and
          fostering an environment where legal rights are protected and upheld.
          The program operates with an open-door policy, welcoming individuals
          from all backgrounds to access legal resources and support.
        </h4>
        {/* </motion.div>    */}
      </div>
      <h2 className="text-center text-4xl my-10">
        Legal Advocacy & Support&apos;s Mission
      </h2>
