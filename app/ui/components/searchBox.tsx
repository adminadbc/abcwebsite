      ...
      {pop ? (
       ...
       h-screen z-[100]  bg-white left-0 backdrop-blur-md bg-opacity-20
        bg-blur-sm"
          ...
          ></div>
          <div
            className="bg-white rounded-lg py-4 drop-shadow-lg z-[9999]
          ...
          >
            <div className=" py-3 px-6 gap-1 flex border-b border-black text-center relative">
              ...
              <div
                ...
                className="p-2 rounded-lg border border-gray-400 cursor-pointer text-sm ml-auto"
              >
                ESC
              </div>
            </div>
            <div className="relative flex flex-col ">
              {history && (
                <div className="flex flex-col gap-2">
                  <div className="font-semibold text-xl px-7 py-5 border-b border-gray-300">
                    Recents{" "}
                  </div>
                  <ul className="flex flex-col text-sm">
                    {historyData?.split(" ").map(
                      (data, idc) =>
                        data.length > 2 && (
                          <li
                            key={idc}
                            className="px-7 border-b border-gray-300 text-gray-500 py-5"
                          >
                            {data}
                          </li>
                        )
