      ...
      {pop && (
        <div className="fixed z-[9999] top-0 w-screen h-screen left-0 overflow-clip">
          <div className="relative pt-16">
            <div
              className="absolute h-screen w-screen top-0 left-0 bg-black backdrop-blur-md	 opacity-80"
              onClick={() => {
                setPop(false);
              }}
            ></div>
            <div className="relative bg-white w-5/6 md:w-1/2 mx-auto p-10 rounded-lg drop-shadow-lg">
              ...
              <div className="flex flex-col space-y-3">
                {results.map((hit, idx) => (
                  <div
                    key={hit.objectID}
                    className="flex justify-start align-middle   border-t border-gray-500"
                  >
                    <div className="py-3">
                      ...
                      {hit.objectID.length > 12 ? (
                        <Link
                          href={hit.url}
                          target="_blank"
                          className="px-6 py-1 flex w-fit gap-2 text-xs
                 ...
                 text-white bg-red-600 flex w-fit  gap-2"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="16"
