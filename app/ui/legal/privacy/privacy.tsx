  ...
  return (
    <section className="p-8">
      <div className="mx-auto max-w-screen-md">
        <p color="blue-gray" className="my-4 font-black text-3xl !leading-snug">
          ADVOCACY FOR BETTER COMMUNITIES FOUNDATION
        </p>
        <p className="mb-10 text-xl">Personal Information Protection Policy</p>
        ...
        <ul className="list-disc mx-5">
          ...
          <li>send out updates and periodic information</li>
        </ul>
        <ul className="list-disc mx-5">
          <li>enroll or register them in a program</li>
          <li>send out updates and periodic information</li>
        ...
        <ul className="list-disc mx-5">
          <li>
            Determining eligibility for employment or volunteer work, including
            verifying qualifications and references
          </li>
          <li>Establishing training and development requirements</li>
          <li>
        ...
        <ul className="list-disc mx-5">
          <li>
            Contact information such as your name, home address, telephone
            number
          </li>
          ...
          <li>
            Financial information, such as pay cheque deposit information and
            tax-related information, including Social Insurance Numbers (paid
            employees only)
          </li>
          <li>
            Other personal information required for the purposes of our
            employment or volunteer relationship
          </li>
        </ul>
        <br />
        <p>
        ...
        <br />
        <p>
          In some cases, after your employment or volunteer relationship with us
          ends, we will be contacted by other organizations and asked to provide
          a reference for you. It is our policy not to disclose personal
          information about our employees and volunteers to other organizations
          who request references without consent. The personal information we
          normally provide in a reference includes:
        </p>
        <ul className="list-disc mx-5">
          <li>
            Confirmation that an individual was an employee or volunteer,
            including the position, and date range of the employment or
            volunteering
          </li>
          <li>Criminal background checks</li>
          <li>
            General information about an individual’s job duties and information
            about the employee or volunteer’s ability to perform job duties and
            success in the employment or volunteer relationship
          </li>
        </ul>
        <p className=" mt-10  text-bold">
        ...
        <br />
        <p>
          We make every reasonable effort to ensure that personal information is
        ...
        <br />
        <p>
          Individuals have a right to access their own personal information in a
          record that is in the custody or under the control of Advocacy For
          Better Communities Foundation, subject to some exceptions. For
          example, organizations are required under the Personal Information
          Protection Act to refuse to provide access to information that would
          reveal personal information about another individual.If we refuse a
          request in whole or in part, we will provide the reasons for the
          refusal. In some cases where exceptions to access apply, we may
        ...
        <p>
          ...
          writing to the office of the Director or an official appointed by the
          Director at the registered official address. You must provide
          sufficient information in your request to allow us to identify the
          information you are seeking. You may also request information about
          our use of your personal information and any disclosure of that
          information to persons outside our organization. In addition, you may
          request a correction of an error or omission in your personal
          information.
        </p>
        <p>
        ...
        <p>
          If you are not satisfied with the response you receive, you should
          contact the Information and Privacy Commissioner of Alberta:
        </p>
        <p>
          Office of the Information and Privacy Commissioner of Alberta Suite
          2460, 801 - 6 Avenue, SW Calgary, Alberta T2P 3W2
        </p>
      </div>
    </section>
  );
